...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO suppliers (name, phone, email, address, city, balance, notes) VALUES (?, ?, ?, ?, ?, ?, ?)");
    $stmt->execute([$name, $phone, $email, $address, $city, $balance, $notes]);
...
<head>
    <meta charset="UTF-8">
    <title>Add Supplier | ElectroERP</title>
    <style>
    ...
    <form method="POST">
        <div class="form-grid">
            <div class="form-group full">
                ...
                <input type="text" name="name" placeholder="e.g. Al-Hamd Traders" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="balance" placeholder="0" step="0.01" value="0">
            </div>
            <div class="form-group full">
                <label>Address</label>
