...
<div class="main">
    <div class="topbar"><h2>Attendance</h2></div>
    <div class="content">
        ...
        <div class="success">✅ Attendance saved for <?php echo $date; ?></div>
        <?php endif; ?>
        <?php if(empty($employees)): ?>
            <div style="text-align:center; padding:40px; color:#64748b;">No active employees found. Add employees first.</div>
        <?php else: ?>
        <form method="POST">
            <table>
