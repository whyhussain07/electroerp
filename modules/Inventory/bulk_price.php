...
<div class="main">
    ...
    <div class="content">
        ...
        <?php if(empty($products)): ?>
            <p style="color:#64748b;">No products found. Add products first.</p>
        <?php else: ?>
        <form method="POST">
            <table>
                <thead>
                ...
                <tr>
                    <td><?php echo htmlspecialchars($p['name']); ?><input type="hidden" name="product_id[]" value="<?php echo $p['id']; ?>"></td>
